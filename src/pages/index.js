...
export default function Home() {
  return (
    <>
      ...
      <div className="overflow-hidden relative h-[1500px] lg:h-[1898px]  flex items-center justify-start  ">
        <img className="absolute top-0 left-0 h-[1500px] lg:h-[1898px] w-full" src="/images/foxmainhero.png" alt="" />
 ...
 BAR
        ...
        <div className="absolute bottom-0 z-50 w-full bg-[#C182608F] py-8 h-[750px] lg:h-[650px]">
          <h2 className="underline underline-offset-4 font-popping text-[48px] font-bold decoration-white text-center">About Us</h2>
          <div className="w-full px-6 grid grid-cols-1 gap-20 lg:grid-cols-2 lg:mt-20 lg:px-10">
            <p className="font-popping  leading-[22px] tracking-wider sm:w-[498px] mx-auto text-[16px] text-[#fff]">
              Right opposite Leicester’s main train station, Hind & PB Lounge is a gastro pub fit for breakfast, lunch and dinner. On London Road, it’s one of the most popular spots in central Leicester thanks to classic British pub food alongside other international favourites, a buzzing atmosphere, well-stocked bar and regular events.

Whether you just want to take the edge off and relax with a coffee or go a bit crazy in the early hours, Hind & PB Lounge is fit for whatever.</p>
<p className="font-popping leading-[22px] tracking-wider sm:w-[498px] mx-auto text-[16px] text-[#fff]">
...
We also have wine, Shots & Liqueurs, Passion Blend, Pina Colada, Margarita, Maitai, Manhattan, Sex On The Beach, Vodka, Cosmopolitan,Classic Mojito, Woo – Woo, Passion Coconut, Blue Lagoon, Spirits, Soft Drinks & Juice, Glass Juice, Bottled Beers and lots more...</p>
          </div>
        </div>
      </div>
      {/* 2 */}
