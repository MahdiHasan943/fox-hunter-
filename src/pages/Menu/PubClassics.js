...
const PubClassics = () => {
  return (
    <>
      {" "}
      <div className={`${style.PUBCLASSICS} h-[550px] relative`}>
        ...
        <div className="">
          ...
          <div className="xl:w-[960px] mx-auto">
            <div className="">
              ...
              with hand cut chips grilled tomato and peppercorn sauce
              </p>
            </div>
            {/* 2 */}
            <div className="py-20">
              <div className="flex justify-between px-2">
                <p className="MDPText dark:text-white text-black ">
                Fox Hut Homemade Beef Burger
                </p>
                <p className="MDPText  py-4 text-[#B5986D]"></p>
              </div>
              <img className="py-2 w-full" src="../../MDLine.png" alt="" />
              <p className="MDSPText dark:text-[#ffffffb3] text-black">
              lettuce, tomato, onion, cheese, bacon, mayo, topped with pickle
and accompanied with homemade hand cut chips
              </p>
            </div>
            {/* 3 */}
            <div className="">
          ...
          <div className="xl:w-[960px] mx-auto">
            <div className="">
              ...
              <p className="MDSPText py-4 dark:text-[#ffffffb3] text-black">
              serves with hand cut chips or salad
              </p>
            </div>
            {/* 2 */}
            <div className="py-20">
              ...
              <img className="py-2 w-full" src="../../MDLine.png" alt="" />
              <p className="MDSPText dark:text-[#ffffffb3] text-black">
              with hand cut chips, peas, tartare sauce, slice
              </p>
            </div>
            {/* 3 */}
            <div className="">
          ...
          <div className="xl:w-[960px] mx-auto">
            <div className="">
              ...
              <p className="MDSPText py-4 dark:text-[#ffffffb3] text-black">
              homemade chips, peas, tartare sauce.
              </p>
            </div>
            {/* 2 */}
            <div className="py-20">
              ...
              <img className="py-2 w-full" src="../../MDLine.png" alt="" />
              <p className="MDSPText dark:text-[#ffffffb3] text-black">
              (opt Ketchup or Mustard) with Homemade chips and fried onions              </p>
            </div>
            {/* 3 */}
            <div className="">
              <div className="flex justify-between px-2">
              ...
              <p className="MDSPText py-4 dark:text-[#ffffffb3] text-black">
              Lettuces, tomato, onion, ketchup, homemade chips              </p>
            </div>
